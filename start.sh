...
curl https://raw.githubusercontent.com/dupontz/homelab/main/mac/main/control-init.yaml | multipass launch -vvvv -n control 20.04 --memory 3G --cloud-init -
curl https://raw.githubusercontent.com/dupontz/homelab/main/mac/multi-main/control2-init.yaml | multipass launch -vvvv -n control2 20.04 --memory 2G --cloud-init -
